...
public static class CSharpCodeGenerator
{
    ...
    private static void EmitReferenceDirectives(StringBuilder sb)
    {
        ...
        // VS's scripting IntelliSense resolves #r and globals from #load'ed files but does
        // NOT propagate using directives to the parent script. Emit them here so the editor
        // can resolve Toolkit, DTE, and helper symbols without manual imports.
