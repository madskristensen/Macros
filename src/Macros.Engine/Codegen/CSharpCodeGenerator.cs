...
public static class CSharpCodeGenerator
{
    ...
    {
        sb.Append("// #load below pulls in the IntelliSense shim (auto-generated by the Macros VSIX)\n");
        sb.Append("// so the C# editor can resolve EnvDTE/EnvDTE80, the Toolkit's VS facade,\n");
