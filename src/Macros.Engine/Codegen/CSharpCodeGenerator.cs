...
public static class CSharpCodeGenerator
{
    ...
    private static void EmitReferenceDirectives(StringBuilder sb)
    {
        ...
        sb.Append('\n');
        // Emit using static directives directly in the macro file so the VS script editor
        // resolves helper methods for completion. The shim also declares these, but the editor
        // does not always propagate 'using static' from #load'd files.
